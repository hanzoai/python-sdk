...
async def test_imports():
    ...
    try:
        ...
        from hanzo.dev import HanzoDevOrchestrator, MultiClaudeOrchestrator, HanzoDevREPL
...
async def test_repl_initialization():
    ...
    try:
        from hanzo.dev import HanzoDevOrchestrator, HanzoDevREPL, MultiClaudeOrchestrator
