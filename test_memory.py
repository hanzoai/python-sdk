...
def test_memory_manager():
    ...
    id1 = memory_manager.add_memory("User prefers Python over JavaScript", type="fact", priority=5)
    console.print(f"✓ Added fact: {id1}")
    
    id2 = memory_manager.add_memory("Always use type hints in Python code", type="instruction", priority=8)
    console.print(f"✓ Added instruction: {id2}")
    
    id3 = memory_manager.add_memory("Working on REST API project", type="context", priority=3)
