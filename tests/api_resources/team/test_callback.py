...
class TestCallback:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_add_with_all_params(self, client: HanzoAI) -> None:
        callback = client.team.callback.add(
            team_id="team_id",
            callback_name="callback_name",
            callback_vars={"foo": "string"},
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_add(self, client: HanzoAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
...
class TestAsyncCallback:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_add_with_all_params(self, async_client: AsyncHanzoAI) -> None:
        callback = await async_client.team.callback.add(
            team_id="team_id",
            callback_name="callback_name",
            callback_vars={"foo": "string"},
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_add(self, async_client: AsyncHanzoAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
