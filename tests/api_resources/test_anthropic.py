...
class TestAnthropic:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_modify(self, client: HanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_modify(self, client: HanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_modify(self, client: HanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_modify(self, client: HanzoAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `endpoint` but received ''"):
...
class TestAsyncAnthropic:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_modify(self, async_client: AsyncHanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_modify(self, async_client: AsyncHanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_modify(self, async_client: AsyncHanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_modify(self, async_client: AsyncHanzoAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `endpoint` but received ''"):
