...
class TestActive:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_callbacks(self, client: HanzoAI) -> None:
        active = client.active.list_callbacks()
        assert_matches_type(object, active, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_callbacks(self, client: HanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list_callbacks(self, client: HanzoAI) -> None:
...
class TestAsyncActive:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_callbacks(self, async_client: AsyncHanzoAI) -> None:
        active = await async_client.active.list_callbacks()
        assert_matches_type(object, active, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_callbacks(self, async_client: AsyncHanzoAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list_callbacks(self, async_client: AsyncHanzoAI) -> None:
