...
class TestHanzo:
    ...
    def test_default_headers_option(self) -> None:
        ...
        assert request.headers.get("x-sdk-lang") == "python"
        ...
        client2 = Hanzo(
            ...
            default_headers={
                "X-Foo": "stainless",
                "X-SDK-Lang": "my-overriding-header",
            },
        )
        request = client2._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "stainless"
        assert request.headers.get("x-sdk-lang") == "my-overriding-header"
    ...
    def test_retries_taken(
        ...
        assert int(response.http_request.headers.get("x-sdk-retry-count")) == failures_before_success
    ...
    def test_omit_retry_count_header(self, client: Hanzo, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        response = client.with_raw_response.get_home(extra_headers={"x-sdk-retry-count": Omit()})

        assert len(response.http_request.headers.get_list("x-sdk-retry-count")) == 0
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.with_raw_response.get_home(extra_headers={"x-sdk-retry-count": "42"})

        assert response.http_request.headers.get("x-sdk-retry-count") == "42"
...
class TestAsyncHanzo:
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.with_raw_response.get_home(extra_headers={"x-sdk-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.with_raw_response.get_home(extra_headers={"x-sdk-retry-count": "42"})
