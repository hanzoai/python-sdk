...
def mock_api(request):
    ...
    with respx.mock(
        ...
        respx_mock.post("/audio/transcriptions").mock(
        ...
        respx_mock.route(method="POST", path__regex=r"/batches/.*/cancel").mock(
            return_value=Response(200, json={})
        )
        ...
        respx_mock.get("/cache/redis/ping").mock(
        ...
        # Config endpoints
        respx_mock.post("/config/pass_through_endpoints").mock(
            return_value=Response(200, json={})
        )
        respx_mock.post("/config/pass_through_endpoint").mock(
            return_value=Response(200, json={})
        )
        respx_mock.route(
            method="PUT", path__regex=r"/config/pass_through_endpoints/.*"
        ).mock(return_value=Response(200, json={}))
        respx_mock.get("/config/pass_through_endpoints").mock(
            return_value=Response(200, json={"data": []})
        )
        respx_mock.get("/config/pass_through_endpoint").mock(
            return_value=Response(200, json={"endpoints": []})
        )
        respx_mock.delete("/config/pass_through_endpoint").mock(
            return_value=Response(200, json={"endpoints": []})
        )
        respx_mock.route(
            method="DELETE", path__regex=r"/config/pass_through_endpoints/.*"
        ).mock(return_value=Response(200, json={}))

        # Engine endpoints
        respx_mock.route(
            method="POST", path__regex=r"/engines/.*/chat/completions"
        ).mock(return_value=Response(200, json={}))
        ...
        respx_mock.route(method="DELETE", path__regex=r"/files/.*").mock(
            return_value=Response(200, json={})
        )

        # Fine-tuning
        respx_mock.post("/fine_tuning/jobs").mock(
        ...
        respx_mock.route(
            method="POST", path__regex=r"/fine_tuning/jobs/.*/cancel"
        ).mock(return_value=Response(200, json={}))
        ...
        # Guardrails
        respx_mock.get("/guardrails/list").mock(
            return_value=Response(200, json={"guardrails": []})
        )
        ...
        # Models
        respx_mock.get("/model/info").mock(
            return_value=Response(200, json={"data": []})
        )
        respx_mock.put("/models/update").mock(return_value=Response(200, json={}))
        respx_mock.route(method="PATCH", path__regex=r"/models/.*").mock(
            return_value=Response(200, json={})
        )
        respx_mock.post("/models").mock(return_value=Response(200, json={}))
        respx_mock.get("/models").mock(return_value=Response(200, json={"data": []}))
        respx_mock.route(method="DELETE", path__regex=r"/models/.*").mock(
            return_value=Response(200, json={})
        )

        # OpenAI deployments
        respx_mock.route(
            method="POST", path__regex=r"/openai/deployments/.*/chat/completions"
        ).mock(return_value=Response(200, json={}))
        respx_mock.route(
            method="POST", path__regex=r"/openai/deployments/.*/completions"
        ).mock(return_value=Response(200, json={}))
        respx_mock.route(
            method="POST", path__regex=r"/openai/deployments/.*/embeddings"
        ).mock(return_value=Response(200, json={}))
        ...
        respx_mock.post("/organization/new").mock(
        ...
        respx_mock.patch("/organization/update").mock(
            return_value=Response(200, json=org_update_response)
        )
        respx_mock.put("/organization/update").mock(
            return_value=Response(200, json=org_update_response)
        )
        respx_mock.put("/organization").mock(return_value=Response(200, json={}))
        respx_mock.delete("/organization/delete").mock(
            return_value=Response(200, json=[org_response])
        )
        ...
        respx_mock.route(method="POST", path__regex=r"/team/.*/callback").mock(
            return_value=Response(200, json={})
        )
        ...
        respx_mock.get("/team/info").mock(
            return_value=Response(200, json=team_response)
        )
        respx_mock.patch("/team/update").mock(
            return_value=Response(200, json=team_response)
        )
        respx_mock.put("/team/update").mock(
            return_value=Response(200, json=team_response)
        )
        respx_mock.put("/team").mock(return_value=Response(200, json={}))
        respx_mock.delete("/team/delete").mock(
            return_value=Response(200, json=[team_response])
        )
        ...
        respx_mock.post("/team/member_add").mock(
            return_value=Response(200, json=team_add_member_response)
        )
        respx_mock.post("/team/members").mock(return_value=Response(200, json={}))
        respx_mock.delete("/team/member_delete").mock(
            return_value=Response(200, json=team_response)
        )
        respx_mock.delete("/team/members").mock(return_value=Response(200, json={}))
        respx_mock.post("/team/member_update").mock(
            return_value=Response(200, json=team_update_member_response)
        )
        respx_mock.patch("/team/member_update").mock(
            return_value=Response(200, json=team_update_member_response)
        )
        respx_mock.put("/team/member_update").mock(
            return_value=Response(200, json=team_update_member_response)
        )
        respx_mock.put("/team/members").mock(return_value=Response(200, json={}))
        respx_mock.post("/team/block").mock(
            return_value=Response(200, json=team_response)
        )
        respx_mock.post("/team/unblock").mock(
            return_value=Response(200, json=team_response)
        )
        ...
        for provider in [
            ...
            respx_mock.get(f"/{provider}").mock(
                return_value=Response(200, json={"data": []})
            )
            respx_mock.route(method="GET", path__regex=rf"/{provider}/.*").mock(
                return_value=Response(200, json={})
            )
            respx_mock.put(f"/{provider}").mock(return_value=Response(200, json={}))
            respx_mock.route(method="PUT", path__regex=rf"/{provider}/.*").mock(
                return_value=Response(200, json={})
            )
            respx_mock.patch(f"/{provider}").mock(return_value=Response(200, json={}))
            respx_mock.route(method="PATCH", path__regex=rf"/{provider}/.*").mock(
                return_value=Response(200, json={})
            )
            respx_mock.delete(f"/{provider}").mock(return_value=Response(200, json={}))
            respx_mock.route(method="DELETE", path__regex=rf"/{provider}/.*").mock(
                return_value=Response(200, json={})
            )
            respx_mock.post(f"/{provider}/modify").mock(
                return_value=Response(200, json={})
            )
            respx_mock.post(f"/{provider}/call").mock(
                return_value=Response(200, json={})
            )

        # Assistants
        respx_mock.post("/assistants").mock(return_value=Response(200, json={}))
        respx_mock.get("/assistants").mock(
            return_value=Response(200, json={"data": []})
        )
        respx_mock.route(method="DELETE", path__regex=r"/assistants/.*").mock(
            return_value=Response(200, json={})
        )
        ...
        # Guardrails
        respx_mock.get("/guardrails").mock(
            return_value=Response(200, json={"data": []})
        )
        ...
        respx_mock.post("/key/generate").mock(
            return_value=Response(200, json={"key": "sk-123"})
        )
        ...
        # Provider
        respx_mock.get("/provider/budgets").mock(
            return_value=Response(200, json={"data": []})
        )
        ...
        respx_mock.route(method="GET", path__regex=r"/threads/[^/]+$").mock(
            return_value=Response(200, json={})
        )
        respx_mock.route(method="PUT", path__regex=r"/threads/.*").mock(
            return_value=Response(200, json={})
        )
        respx_mock.route(method="DELETE", path__regex=r"/threads/.*").mock(
            return_value=Response(200, json={})
        )
        respx_mock.route(method="POST", path__regex=r"/threads/.*/messages").mock(
            return_value=Response(200, json={})
        )
        respx_mock.route(method="GET", path__regex=r"/threads/.*/messages").mock(
            return_value=Response(200, json={"data": []})
        )
        respx_mock.route(method="POST", path__regex=r"/threads/.*/runs").mock(
            return_value=Response(200, json={})
        )
        ...
        respx_mock.get("/user/info").mock(
            return_value=Response(200, json=user_response)
        )
        respx_mock.put("/user/update").mock(
            return_value=Response(200, json=user_response)
        )
        respx_mock.put("/user").mock(return_value=Response(200, json={}))
        respx_mock.delete("/user/delete").mock(
            return_value=Response(200, json=user_response)
        )
        respx_mock.delete("/user").mock(return_value=Response(200, json={}))

        # Utils
        respx_mock.get("/utils/supported_openai_params").mock(
            return_value=Response(200, json={})
        )
        ...
        # Home/client
        respx_mock.get("/").mock(
            return_value=Response(200, json={"message": "Welcome"})
        )
