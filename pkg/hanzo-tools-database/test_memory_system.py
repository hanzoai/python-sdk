...
async def test_memory_system():
    ...
    from hanzo_tools.database.init_memory import init_global_memory, init_project_memory
    ...
    try:
        result = await memory_tool.call(ctx, action="list", scope="both")
    ...
    try:
        result = await memory_tool.call(ctx, action="stats", scope="both")
