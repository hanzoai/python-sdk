...
class MemoryManager:
    ...
    def write_markdown_file(self, file_path: str, content: str, scope: str = "project", 
                           project_path: str = None, category: str = None) -> bool:
    ...
    def append_markdown_file(self, file_path: str, content: str, scope: str = "project",
                            project_path: str = None, category: str = None) -> bool:
    ...
    def create_memory(self, content: str, category: str = None, importance: int = 5,
                     metadata: Dict[str, Any] = None, scope: str = "project",
    ...
    # Search operations
    def search_memories(self, query: str, scope: str = "both", project_path: str = None,
                       search_type: str = "fulltext", limit: int = 10) -> List[Dict[str, Any]]:
    ...
    def _search_structured_memories(self, query: str, scope: str, project_path: str, limit: int) -> List[Dict[str, Any]]:
