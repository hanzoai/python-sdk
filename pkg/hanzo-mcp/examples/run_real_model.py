...
async def main():
    ...
    assistant = create_agent(
        ...
        tools=[
            create_tool(name="summarize_text", description="Summarize text", handler=summarize_text),
            create_tool(name="answer_question", description="Answer questions", handler=answer_question)
        ]
    )
