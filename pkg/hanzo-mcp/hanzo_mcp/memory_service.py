...
from .plugin_interface import PluginRegistry, MemoryBackendPlugin, Capability
...
class PluginMemoryService:
    ...
    async def store_memory(self, content: str, metadata: Dict[str, Any], user_id: str = "default", project_id: str = "default") -> str:
    ...
    async def retrieve_memory(self, query: str, user_id: str = "default", project_id: str = "default", limit: int = 10) -> List[Dict[str, Any]]:
    ...
    async def search_memory(self, query: str, user_id: str = "default", project_id: str = "default", limit: int = 10) -> List[Dict[str, Any]]:
