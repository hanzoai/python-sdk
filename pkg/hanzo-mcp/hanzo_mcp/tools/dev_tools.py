...
BackendType = Literal["auto", "go", "pnpm", "yarn", "npm", "bun", "pytest", "uv", "poetry", "cargo", "cmake", "ninja", "make", "buf", "capnp"]
...
class DevToolBase:
    ...
    def __init__(self, target: str, language: LanguageType = "auto", 
                 backend: BackendType = "auto", root: Optional[str] = None,
