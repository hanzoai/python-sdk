...
async def test_complete_system():
    ...
    for i, result in enumerate(search_results):
        print(f"  Result {i+1}: {result['content'][:60]}... (score: {result.get('similarity_score', 'N/A')})")
    ...
    print("✅ Settings management works properly with ~/.config/hanzo/mcp-settings.json")
