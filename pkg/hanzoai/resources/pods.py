...
class PodsResource(SyncAPIResource):
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query={"namespace": namespace, "label_selector": label_selector},
            ),
            cast_to=object,
        )
    ...
    def create(
        ...
        *,
        ...
        namespace: str,
        image: str,
        command: List[str] | NotGiven = NOT_GIVEN,
        env: Dict[str, str] | NotGiven = NOT_GIVEN,
        resources: Dict[str, Any] | NotGiven = NOT_GIVEN,
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ...
    def logs(
        ...
        *,
        ...
        """Get pod logs."""
        return self._get(
            f"/infrastructure/pods/{pod_id}/logs",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query={"container": container, "tail": tail, "follow": follow},
            ),
            cast_to=object,
        )
