...
class SyncApi:
    ...
    def delete_sync_by_id(
        ...
        _param = self._delete_sync_by_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_sync_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_sync_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_sync_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_sync_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_sync_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def post_sync_by_id_run(
        ...
        _param = self._post_sync_by_id_run_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_sync_by_id_run_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_sync_by_id_run_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the sync to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _post_sync_by_id_run_serialize(
        self,
        id,
        _request_auth,
        _content_type,
