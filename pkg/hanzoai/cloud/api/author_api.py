...
class AuthorApi:
    ...
    def get_author_basis(
        ...
        _param = self._get_author_basis_serialize(
            period=period,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_author_basis_with_http_info(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Period is the UTC accrual month, YYYY-MM. Empty means every period; any other shape is refused with 400, because the period is echoed back and used as a SQL filter and is only ever accepted in the one form the accrual latch mints.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_author_basis_without_preload_content(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Period is the UTC accrual month, YYYY-MM. Empty means every period; any other shape is refused with 400, because the period is echoed back and used as a SQL filter and is only ever accepted in the one form the accrual latch mints.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_author_basis_serialize(
        self,
        period,
        _request_auth,
        _content_type,
    ...
    def _post_author_connect_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/author/connect',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_author_deploys_record_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/author/deploys/record',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_author_repos_verify_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/author/repos/verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
