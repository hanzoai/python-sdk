...
class AllowanceApi:
    ...
    def get_allowance(
        ...
        _param = self._get_allowance_serialize(
    ...
    @validate_call
    def get_allowance_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_allowance_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
