...
class WebhooksApi:
    ...
    def delete_v1_webhooks_id(
        ...
        _param = self._delete_v1_webhooks_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_v1_webhooks_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_v1_webhooks_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_v1_webhooks_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_v1_webhooks_id(
        ...
        _param = self._get_v1_webhooks_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_webhooks_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_webhooks_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_v1_webhooks_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_v1_webhooks_id_deliveries(
        self,
        id: StrictStr,
        ...
        _param = self._get_v1_webhooks_id_deliveries_serialize(
            id=id,
            limit=limit,
            status=status,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_v1_webhooks_id_deliveries_with_http_info(
        self,
        id: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps how many attempts come back: default 50, maximum 200. A value that is not a positive integer reads as the default.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Status narrows the log to one outcome: \"ok\", \"retrying\" or \"failed\". Empty returns every attempt.")] = None,
    ...
    @validate_call
    def get_v1_webhooks_id_deliveries_without_preload_content(
        self,
        id: StrictStr,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps how many attempts come back: default 50, maximum 200. A value that is not a positive integer reads as the default.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Status narrows the log to one outcome: \"ok\", \"retrying\" or \"failed\". Empty returns every attempt.")] = None,
    ...
    def _get_v1_webhooks_id_deliveries_serialize(
        self,
        id,
        limit,
        status,
    ...
    @validate_call
    def post_v1_webhooks_id_secret(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._post_v1_webhooks_id_secret_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_v1_webhooks_id_secret_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v1_webhooks_id_secret_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _post_v1_webhooks_id_secret_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/webhooks/{id}/secret',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_v1_webhooks_id_test(
        ...
        _param = self._post_v1_webhooks_id_test_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_v1_webhooks_id_test_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v1_webhooks_id_test_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _post_v1_webhooks_id_test_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def put_v1_webhooks_id(
        ...
        _param = self._put_v1_webhooks_id_serialize(
            id=id,
    ...
    @validate_call
    def put_v1_webhooks_id_with_http_info(
        self,
        id: StrictStr,
        update_endpoint_in: UpdateEndpointIn,
        _request_timeout: Union[
    ...
    @validate_call
    def put_v1_webhooks_id_without_preload_content(
        self,
        id: StrictStr,
        update_endpoint_in: UpdateEndpointIn,
        _request_timeout: Union[
    ...
    def _put_v1_webhooks_id_serialize(
        self,
        id,
        update_endpoint_in,
        _request_auth,
