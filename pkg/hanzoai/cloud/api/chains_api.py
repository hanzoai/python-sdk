...
class ChainsApi:
    ...
    @validate_call
    def get_chains_by_chain(
        self,
        chain: Annotated[StrictStr, Field(description="Chain is the registry id, as in /v1/chains/lux.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_chains_by_chain_serialize(
            chain=chain,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_chains_by_chain_with_http_info(
        self,
        chain: Annotated[StrictStr, Field(description="Chain is the registry id, as in /v1/chains/lux.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_chains_by_chain_without_preload_content(
        self,
        chain: Annotated[StrictStr, Field(description="Chain is the registry id, as in /v1/chains/lux.")],
        _request_timeout: Union[
            None,
    ...
    def _get_chains_by_chain_serialize(
        self,
        chain,
        _request_auth,
        _content_type,
