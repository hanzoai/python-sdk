...
class TeamApi:
    ...
    @validate_call
    def delete_v1_team_files_workspace_filename(
        self,
        ...
        _param = self._delete_v1_team_files_workspace_filename_serialize(
            workspace=workspace,
            filename=filename,
            file=file,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_v1_team_files_workspace_filename_with_http_info(
        self,
        workspace: Annotated[StrictStr, Field(description="Workspace is the workspace uuid the blob belongs to, from the path.")],
        filename: Annotated[StrictStr, Field(description="Filename is the last path segment, which the front sets to the blob id when it sends no explicit `file`.")],
        file: Annotated[Optional[StrictStr], Field(description="File is the blob id, and wins over the path segment when both are present.")] = None,
    ...
    @validate_call
    def delete_v1_team_files_workspace_filename_without_preload_content(
        self,
        workspace: Annotated[StrictStr, Field(description="Workspace is the workspace uuid the blob belongs to, from the path.")],
        filename: Annotated[StrictStr, Field(description="Filename is the last path segment, which the front sets to the blob id when it sends no explicit `file`.")],
        file: Annotated[Optional[StrictStr], Field(description="File is the blob id, and wins over the path segment when both are present.")] = None,
    ...
    def _delete_v1_team_files_workspace_filename_serialize(
        self,
        workspace,
        filename,
        file,
