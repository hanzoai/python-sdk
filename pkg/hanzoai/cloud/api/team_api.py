...
class TeamApi:
    ...
    def get_v1_team_account_auth_by_provider_callback(
        ...
        """Completes a sign-in and hands the browser its session.
    ...
    def get_v1_team_billing_ui_by_wildcard1(
        ...
        """Loads an asset of the wallet page.
    ...
    def post_v1_team_account(
        ...
        """Reads the caller's account and switches workspace.
    ...
    def post_v1_team_files_by_workspace(
        ...
        """Uploads a file into a workspace.
    ...
    def put_v1_team_account_cookie(
        ...
        """Stores the session token as this browser's cookie.
