...
class ValidatorsApi:
    ...
    def cloud_get_v1_validators(
        ...
        _param = self._cloud_get_v1_validators_serialize(
            limit=limit,
    ...
    @validate_call
    def cloud_get_v1_validators_with_http_info(
        self,
        limit: Annotated[Optional[StrictStr], Field(description="Limit is how many slots to return, as a decimal string in the `?limit=` query. Absent, unparseable or non-positive means 200; over 1000 is clamped to 1000. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudValidatorList]:
        """Returns the validator slots the caller's org has claimed.
    ...
    @validate_call
    def cloud_get_v1_validators_without_preload_content(
        self,
        limit: Annotated[Optional[StrictStr], Field(description="Limit is how many slots to return, as a decimal string in the `?limit=` query. Absent, unparseable or non-positive means 200; over 1000 is clamped to 1000. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_validators_serialize(
        self,
        limit,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_get_v1_validators_challenge(
        self,
        ...
        _param = self._cloud_get_v1_validators_challenge_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_validators_challenge_with_http_info(
        self,
        token_id: Annotated[Optional[StrictStr], Field(description="TokenID is the Validator-tier GenesisNFT token id, as a decimal string in the `?tokenId=` query. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudChallengeView]:
        """Issues the single-use nonce and the exact message a wallet must sign to claim a validator slot.
    ...
    @validate_call
    def cloud_get_v1_validators_challenge_without_preload_content(
        self,
        token_id: Annotated[Optional[StrictStr], Field(description="TokenID is the Validator-tier GenesisNFT token id, as a decimal string in the `?tokenId=` query. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_validators_challenge_serialize(
        self,
        token_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_get_v1_validators_token_id(
        self,
        ...
        _param = self._cloud_get_v1_validators_token_id_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_validators_token_id_with_http_info(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_validators_token_id_without_preload_content(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_validators_token_id_serialize(
        self,
        token_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_post_v1_validators(
        self,
        cloud_validator_claim: CloudValidatorClaim,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_validator_claim: (required)
        :type cloud_validator_claim: CloudValidatorClaim
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_validators_serialize(
            cloud_validator_claim=cloud_validator_claim,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_validators_with_http_info(
        self,
        cloud_validator_claim: CloudValidatorClaim,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_validators_without_preload_content(
        self,
        cloud_validator_claim: CloudValidatorClaim,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_validators_serialize(
        self,
        cloud_validator_claim,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_validator_claim is not None:
            _body_params = cloud_validator_claim
