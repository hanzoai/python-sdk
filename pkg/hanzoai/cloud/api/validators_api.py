...
class ValidatorsApi:
    ...
    @validate_call
    def get_v1_validators_token_id(
        self,
        ...
        _param = self._get_v1_validators_token_id_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_validators_token_id_with_http_info(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_validators_token_id_without_preload_content(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_validators_token_id_serialize(
        self,
        token_id,
        _request_auth,
        _content_type,
