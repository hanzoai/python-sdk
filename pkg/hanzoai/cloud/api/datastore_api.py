...
class DatastoreApi:
    ...
    def delete_datastore_by_name(
        ...
        _param = self._delete_datastore_by_name_serialize(
            name=name,
    ...
    @validate_call
    def delete_datastore_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_datastore_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_datastore_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def get_datastore_by_name(
        ...
        _param = self._get_datastore_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_datastore_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_datastore_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    def _get_datastore_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def post_datastore(
        ...
        _param = self._post_datastore_serialize(
    ...
    @validate_call
    def post_datastore_with_http_info(
        self,
        provision_request: Optional[ProvisionRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_datastore_without_preload_content(
        self,
        provision_request: Optional[ProvisionRequest] = None,
        _request_timeout: Union[
            None,
