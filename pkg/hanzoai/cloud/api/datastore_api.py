...
class DatastoreApi:
    ...
    @validate_call
    def delete_v1_datastore_by_name(
        self,
        ...
        _param = self._delete_v1_datastore_by_name_serialize(
            name=name,
    ...
    @validate_call
    def delete_v1_datastore_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_v1_datastore_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_v1_datastore_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def get_v1_datastore(
        ...
        _param = self._get_v1_datastore_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_v1_datastore_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_v1_datastore_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_v1_datastore_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_v1_datastore_by_name(
        ...
        _param = self._get_v1_datastore_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_datastore_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_datastore_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_datastore_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def post_v1_datastore(
        ...
        _param = self._post_v1_datastore_serialize(
    ...
    @validate_call
    def post_v1_datastore_with_http_info(
        self,
        provision_request: Optional[ProvisionRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v1_datastore_without_preload_content(
        self,
        provision_request: Optional[ProvisionRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_v1_datastore_serialize(
        self,
        provision_request,
        _request_auth,
        _content_type,
