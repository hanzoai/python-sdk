...
class MemoryApi:
    ...
    def _get_memory_recall_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/memory/recall',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_memory_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/memory/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_memory_remember_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/memory/remember',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_memory_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/memory/update',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
