...
class NetworksApi:
    ...
    def cloud_get_v1_networks(
        ...
        _param = self._cloud_get_v1_networks_serialize(
    ...
    @validate_call
    def cloud_get_v1_networks_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cloud_get_v1_networks_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_get_v1_networks_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def cloud_get_v1_networks_id(
        ...
        _param = self._cloud_get_v1_networks_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_networks_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the network id from the path. The URL is the addressing authority, so it binds from there whatever else the request carries.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_networks_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the network id from the path. The URL is the addressing authority, so it binds from there whatever else the request carries.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_networks_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
