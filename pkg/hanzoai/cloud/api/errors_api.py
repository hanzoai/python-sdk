...
class ErrorsApi:
    ...
    def cloud_get_v1_errors(
        ...
        _param = self._cloud_get_v1_errors_serialize(
            limit=limit,
    ...
    @validate_call
    def cloud_get_v1_errors_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Limit is how many rows to return, newest first. Default 50, maximum 200; a value at or below zero, or one that is not a number, takes the default.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_errors_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Limit is how many rows to return, newest first. Default 50, maximum 200; a value at or below zero, or one that is not a number, takes the default.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_errors_serialize(
        self,
        limit,
        _request_auth,
        _content_type,
