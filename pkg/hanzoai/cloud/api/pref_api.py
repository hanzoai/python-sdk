...
class PrefApi:
    ...
    def get_pref(
        ...
        _param = self._get_pref_serialize(
    ...
    @validate_call
    def get_pref_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def patch_pref(
        ...
        _param = self._patch_pref_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_pref_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
