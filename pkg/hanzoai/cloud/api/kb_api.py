...
class KbApi:
    ...
    @validate_call
    def cloud_delete_v1_kb_connectors_provider(
        self,
        ...
        _param = self._cloud_delete_v1_kb_connectors_provider_serialize(
            provider=provider,
    ...
    @validate_call
    def cloud_delete_v1_kb_connectors_provider_with_http_info(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudConnectionOut]:
        """DisconnectConnector revokes a connection: it tombstones the stored credential so a later sync cannot reuse it, purges this provider's points from the org's vector namespace, and marks the connector disconnected.
    ...
    @validate_call
    def cloud_delete_v1_kb_connectors_provider_without_preload_content(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_delete_v1_kb_connectors_provider_serialize(
        self,
        provider,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._cloud_get_v1_kb_connectors_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudKbConnectorsOut]:
        """ListConnectors returns every supported knowledge connector with THIS org's connection state and the REAL number of documents each has ingested into the org's store.
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_get_v1_kb_connectors_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_catalog(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._cloud_get_v1_kb_connectors_catalog_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_catalog_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_catalog_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_get_v1_kb_connectors_catalog_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_callback(
        self,
        ...
        _param = self._cloud_get_v1_kb_connectors_provider_callback_serialize(
            provider=provider,
            code=code,
            state=state,
            error=error,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_callback_with_http_info(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector completing its flow, from the path.")],
        code: Annotated[Optional[StrictStr], Field(description="Code is the provider's authorization code, exchanged for a token.")] = None,
        state: Annotated[Optional[StrictStr], Field(description="State is the org-bound value this server signed at connect time.")] = None,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_callback_without_preload_content(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector completing its flow, from the path.")],
        code: Annotated[Optional[StrictStr], Field(description="Code is the provider's authorization code, exchanged for a token.")] = None,
        state: Annotated[Optional[StrictStr], Field(description="State is the org-bound value this server signed at connect time.")] = None,
    ...
    def _cloud_get_v1_kb_connectors_provider_callback_serialize(
        self,
        provider,
        code,
        state,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_connect(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._cloud_get_v1_kb_connectors_provider_connect_serialize(
            provider=provider,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_connect_with_http_info(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudKbAuthorizeOut]:
        """StartConnectorOAuth returns the provider authorize URL the console opens to connect this org's account.
    ...
    @validate_call
    def cloud_get_v1_kb_connectors_provider_connect_without_preload_content(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_kb_connectors_provider_connect_serialize(
        self,
        provider,
        _request_auth,
        _content_type,
    ...
    def cloud_get_v1_kb_graph(
        ...
        _param = self._cloud_get_v1_kb_graph_serialize(
            project=project,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_kb_graph_with_http_info(
        self,
        project: Annotated[Optional[StrictStr], Field(description="Project narrows the graph to one project scope. Empty reads the whole org.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_kb_graph_without_preload_content(
        self,
        project: Annotated[Optional[StrictStr], Field(description="Project narrows the graph to one project scope. Empty reads the whole org.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_kb_graph_serialize(
        self,
        project,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_post_v1_kb_connectors_provider_sync(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._cloud_post_v1_kb_connectors_provider_sync_serialize(
            provider=provider,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_post_v1_kb_connectors_provider_sync_with_http_info(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_kb_connectors_provider_sync_without_preload_content(
        self,
        provider: Annotated[StrictStr, Field(description="Provider is the connector to act on: github, slack, google or notion.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_kb_connectors_provider_sync_serialize(
        self,
        provider,
        _request_auth,
        _content_type,
    ...
    def cloud_post_v1_kb_import(
        ...
        _param = self._cloud_post_v1_kb_import_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_kb_import_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cloud_post_v1_kb_import_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_post_v1_kb_import_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def cloud_post_v1_kb_search(
        self,
        cloud_search_in: CloudSearchIn,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_search_in: (required)
        :type cloud_search_in: CloudSearchIn
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_kb_search_serialize(
            cloud_search_in=cloud_search_in,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_kb_search_with_http_info(
        self,
        cloud_search_in: CloudSearchIn,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_kb_search_without_preload_content(
        self,
        cloud_search_in: CloudSearchIn,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_kb_search_serialize(
        self,
        cloud_search_in,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_search_in is not None:
            _body_params = cloud_search_in
