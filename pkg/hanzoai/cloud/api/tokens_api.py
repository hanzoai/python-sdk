...
class TokensApi:
    ...
    @validate_call
    def get_tokens_by_chain_by_address(
        self,
        ...
        _param = self._get_tokens_by_chain_by_address_serialize(
            chain=chain,
            address=address,
    ...
    @validate_call
    def get_tokens_by_chain_by_address_with_http_info(
        self,
        chain: Annotated[StrictStr, Field(description="Chain is the registry id.")],
        address: Annotated[StrictStr, Field(description="Address is the account, 0x-prefixed.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_tokens_by_chain_by_address_without_preload_content(
        self,
        chain: Annotated[StrictStr, Field(description="Chain is the registry id.")],
        address: Annotated[StrictStr, Field(description="Address is the account, 0x-prefixed.")],
        _request_timeout: Union[
    ...
    def _get_tokens_by_chain_by_address_serialize(
        self,
        chain,
        address,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tokens/{chain}/{address}',
