...
class BotsApi:
    ...
    def post_v1_bots_run_id_stop(
        ...
        _param = self._post_v1_bots_run_id_stop_serialize(
            run_id=run_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_v1_bots_run_id_stop_with_http_info(
        self,
        run_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_v1_bots_run_id_stop_without_preload_content(
        self,
        run_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _post_v1_bots_run_id_stop_serialize(
        self,
        run_id,
        _request_auth,
        _content_type,
