...
class BalancersApi:
    ...
    def delete_v1_balancers_id(
        ...
        _param = self._delete_v1_balancers_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_v1_balancers_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_v1_balancers_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_v1_balancers_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_v1_balancers_id(
        ...
        _param = self._get_v1_balancers_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_balancers_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_balancers_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_balancers_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
