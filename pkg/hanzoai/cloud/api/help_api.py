...
class HelpApi:
    ...
    @validate_call
    def cloud_get_v1_help_articles(
        self,
        ...
        _param = self._cloud_get_v1_help_articles_serialize(
            category=category,
            limit=limit,
    ...
    @validate_call
    def cloud_get_v1_help_articles_with_http_info(
        self,
        category: Annotated[Optional[StrictStr], Field(description="Category narrows the list to one knowledge-base section, matched against the article's category by exact name. Empty lists every section.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps how many articles are returned. Anything that is not a positive integer uses 50, and values above 200 are clamped to 200.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudHelpArticleList]:
        """Returns the public knowledge base: the help center's Published, publicly-visible articles as cards.
    ...
    @validate_call
    def cloud_get_v1_help_articles_without_preload_content(
        self,
        category: Annotated[Optional[StrictStr], Field(description="Category narrows the list to one knowledge-base section, matched against the article's category by exact name. Empty lists every section.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps how many articles are returned. Anything that is not a positive integer uses 50, and values above 200 are clamped to 200.")] = None,
        _request_timeout: Union[
    ...
    def _cloud_get_v1_help_articles_serialize(
        self,
        category,
        limit,
        _request_auth,
    ...
    @validate_call
    def cloud_get_v1_help_articles_slug(
        self,
        ...
        _param = self._cloud_get_v1_help_articles_slug_serialize(
            slug=slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_help_articles_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the article's public identifier, from the path. It IS the document name in the help center's store.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_help_articles_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the article's public identifier, from the path. It IS the document name in the help center's store.")],
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_help_articles_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_get_v1_help_categories(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._cloud_get_v1_help_categories_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_get_v1_help_categories_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudHelpCategoryList]:
        """Returns the knowledge-base sections for the public center's navigation — but ONLY the sections that front at least one Published, public article, so an internal (agent-only) category name or description never leaks.
    ...
    @validate_call
    def cloud_get_v1_help_categories_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_get_v1_help_categories_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def cloud_post_v1_help_tickets(
        self,
        cloud_help_ticket_intake: CloudHelpTicketIntake,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_help_ticket_intake: (required)
        :type cloud_help_ticket_intake: CloudHelpTicketIntake
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_help_tickets_serialize(
            cloud_help_ticket_intake=cloud_help_ticket_intake,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_help_tickets_with_http_info(
        self,
        cloud_help_ticket_intake: CloudHelpTicketIntake,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudHelpTicketFiled]:
        """Files a customer support ticket into the public help center.
    ...
    @validate_call
    def cloud_post_v1_help_tickets_without_preload_content(
        self,
        cloud_help_ticket_intake: CloudHelpTicketIntake,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_help_tickets_serialize(
        self,
        cloud_help_ticket_intake,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_help_ticket_intake is not None:
            _body_params = cloud_help_ticket_intake
