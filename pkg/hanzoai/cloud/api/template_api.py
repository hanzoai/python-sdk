...
class TemplateApi:
    ...
    def delete_template_by_slug(
        ...
        _param = self._delete_template_by_slug_serialize(
            slug=slug,
    ...
    @validate_call
    def delete_template_by_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_template_by_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_template_by_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/template/{slug}',
    ...
    def get_template_by_slug(
        ...
        _param = self._get_template_by_slug_serialize(
            slug=slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_template_by_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_template_by_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _get_template_by_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
