...
class EmbedStatusApi:
    ...
    def cloud_get_v1_embed_status(
        ...
        _param = self._cloud_get_v1_embed_status_serialize(
            app=app,
    ...
    @validate_call
    def cloud_get_v1_embed_status_with_http_info(
        self,
        app: Annotated[Optional[StrictStr], Field(description="App is the embedded app to report on: cms (Content Studio), erp or help.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CloudEmbedStatusResp]:
        """EmbedStatus reports whether one of this brand's shared embedded apps (cms, erp, help) may be framed by the caller and is actually running, so a console module can choose between the embed and the provision panel.
    ...
    @validate_call
    def cloud_get_v1_embed_status_without_preload_content(
        self,
        app: Annotated[Optional[StrictStr], Field(description="App is the embedded app to report on: cms (Content Studio), erp or help.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_embed_status_serialize(
        self,
        app,
        _request_auth,
        _content_type,
