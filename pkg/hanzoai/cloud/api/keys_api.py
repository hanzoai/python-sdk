...
class KeysApi:
    ...
    def v1_delete_keys(
        ...
        _param = self._v1_delete_keys_serialize(
            type=type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v1_delete_keys_with_http_info(
        self,
        type: Annotated[Optional[StrictStr], Field(description="Type is the key class to act on: \"secret\" (sk-, session-equivalent, belongs on a server) or \"publishable\" (pk-, org-identifying, safe in a browser bundle). Omitted means secret, which is what every existing caller means.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_delete_keys_without_preload_content(
        self,
        type: Annotated[Optional[StrictStr], Field(description="Type is the key class to act on: \"secret\" (sk-, session-equivalent, belongs on a server) or \"publishable\" (pk-, org-identifying, safe in a browser bundle). Omitted means secret, which is what every existing caller means.")] = None,
        _request_timeout: Union[
            None,
    ...
    def v1_post_keys(
        ...
        _param = self._v1_post_keys_serialize(
    ...
    @validate_call
    def v1_post_keys_with_http_info(
        self,
        key_type_in: KeyTypeIn,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_post_keys_without_preload_content(
        self,
        key_type_in: KeyTypeIn,
        _request_timeout: Union[
            None,
