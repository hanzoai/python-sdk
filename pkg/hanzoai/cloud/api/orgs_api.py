...
class OrgsApi:
    ...
    @validate_call
    def get_v1_orgs_org_entitlements(
        self,
        org: StrictStr,
        ...
        _param = self._get_v1_orgs_org_entitlements_serialize(
            org=org,
    ...
    @validate_call
    def get_v1_orgs_org_entitlements_with_http_info(
        self,
        org: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_orgs_org_entitlements_without_preload_content(
        self,
        org: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_v1_orgs_org_entitlements_serialize(
        self,
        org,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def post_v1_orgs_org_entitlements(
        self,
        org: StrictStr,
        ...
        _param = self._post_v1_orgs_org_entitlements_serialize(
            org=org,
    ...
    @validate_call
    def post_v1_orgs_org_entitlements_with_http_info(
        self,
        org: StrictStr,
        mutate_req: MutateReq,
        _request_timeout: Union[
    ...
    @validate_call
    def post_v1_orgs_org_entitlements_without_preload_content(
        self,
        org: StrictStr,
        mutate_req: MutateReq,
        _request_timeout: Union[
    ...
    def _post_v1_orgs_org_entitlements_serialize(
        self,
        org,
        mutate_req,
        _request_auth,
    ...
    def v1_post_orgs(
        ...
        _param = self._v1_post_orgs_serialize(
    ...
    @validate_call
    def v1_post_orgs_with_http_info(
        self,
        onboard_req: OnboardReq,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_post_orgs_without_preload_content(
        self,
        onboard_req: OnboardReq,
        _request_timeout: Union[
            None,
