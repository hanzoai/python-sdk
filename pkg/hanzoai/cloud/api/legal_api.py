...
class LegalApi:
    ...
    def get_v1_legal_documents_id(
        ...
        _param = self._get_v1_legal_documents_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_legal_documents_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the document's server-minted handle, \"doc_\"-prefixed.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_legal_documents_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the document's server-minted handle, \"doc_\"-prefixed.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_legal_documents_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_v1_legal_templates_id(
        ...
        _param = self._get_v1_legal_templates_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_legal_templates_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the template's stable id, e.g. \"nda\" or \"safe\".")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_legal_templates_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the template's stable id, e.g. \"nda\" or \"safe\".")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_legal_templates_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def post_v1_legal_documents_id_sign(
        self,
        ...
        _param = self._post_v1_legal_documents_id_sign_serialize(
            id=id,
    ...
    @validate_call
    def post_v1_legal_documents_id_sign_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the document to send for signature, from the path.")],
        sign_request: SignRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def post_v1_legal_documents_id_sign_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the document to send for signature, from the path.")],
        sign_request: SignRequest,
        _request_timeout: Union[
    ...
    def _post_v1_legal_documents_id_sign_serialize(
        self,
        id,
        sign_request,
        _request_auth,
    ...
    def put_v1_legal_templates_id(
        ...
        _param = self._put_v1_legal_templates_id_serialize(
            id=id,
    ...
    @validate_call
    def put_v1_legal_templates_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the template to override, from the path. Overriding a built-in id inherits that built-in's category, title and counsel-review posture.")],
        template_override: TemplateOverride,
        _request_timeout: Union[
    ...
    @validate_call
    def put_v1_legal_templates_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the template to override, from the path. Overriding a built-in id inherits that built-in's category, title and counsel-review posture.")],
        template_override: TemplateOverride,
        _request_timeout: Union[
    ...
    def _put_v1_legal_templates_id_serialize(
        self,
        id,
        template_override,
        _request_auth,
