...
class PromptApi:
    ...
    def get_prompt_by_name(
        ...
        _param = self._get_prompt_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_prompt_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name is the prompt to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_prompt_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name is the prompt to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _get_prompt_by_name_serialize(
        self,
        name,
        _request_auth,
        _content_type,
    ...
    def get_prompt_catalog(
        ...
        _param = self._get_prompt_catalog_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_prompt_catalog_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_prompt_catalog_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_prompt_catalog_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/prompt/catalog',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_prompt_metrics(
        ...
        _param = self._get_prompt_metrics_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_prompt_metrics_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_prompt_metrics_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_prompt_metrics_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/prompt/metrics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
