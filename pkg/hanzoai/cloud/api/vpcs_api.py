...
class VpcsApi:
    ...
    def delete_vpcs_by_id(
        ...
        _param = self._delete_vpcs_by_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_vpcs_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_vpcs_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_vpcs_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_vpcs_by_id(
        ...
        _param = self._get_vpcs_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_vpcs_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_vpcs_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the DigitalOcean resource id (a UUID), from the path.")],
        _request_timeout: Union[
            None,
    ...
    def post_vpcs(
        ...
        :param create_vpc_req: (required)
        :type create_vpc_req: CreateVPCReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_vpcs_serialize(
            create_vpc_req=create_vpc_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_vpcs_without_preload_content(
        self,
        create_vpc_req: CreateVPCReq,
        _request_timeout: Union[
            None,
    ...
    def _post_vpcs_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_vpc_req is not None:
            _body_params = create_vpc_req
