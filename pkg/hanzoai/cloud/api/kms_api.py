...
class KmsApi:
    ...
    def delete_v1_kms_secrets_by_wildcard1(
        ...
        """Deletes one secret from the caller's org.
    ...
    def get_v1_kms_config(
        ...
        """Serves the runtime configuration for the KMS console.
    ...
    def get_v1_kms_secrets(
        ...
        """Lists the secrets the caller's org holds, without their values.
    ...
    def post_v1_kms_secrets(
        ...
        """Stores or replaces one secret in the caller's org.
