...
class ValidatorApi:
    ...
    def get_validator_by_tokenid(
        ...
        _param = self._get_validator_by_tokenid_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_validator_by_tokenid_with_http_info(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_validator_by_tokenid_without_preload_content(
        self,
        token_id: Annotated[StrictStr, Field(description="TokenID is the slot's GenesisNFT token id, from the path, as a decimal string. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")],
        _request_timeout: Union[
            None,
    ...
    def _get_validator_by_tokenid_serialize(
        self,
        token_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/validator/{tokenId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_validator_challenge(
        ...
        _param = self._get_validator_challenge_serialize(
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_validator_challenge_with_http_info(
        self,
        token_id: Annotated[Optional[StrictStr], Field(description="TokenID is the Validator-tier GenesisNFT token id, as a decimal string in the `?tokenId=` query. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_validator_challenge_without_preload_content(
        self,
        token_id: Annotated[Optional[StrictStr], Field(description="TokenID is the Validator-tier GenesisNFT token id, as a decimal string in the `?tokenId=` query. A value that is not a positive integer is 400. It is a string rather than a number because the parse that has always served this route trims surrounding whitespace, and one parse rule is better than two.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_validator_challenge_serialize(
        self,
        token_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/validator/challenge',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
