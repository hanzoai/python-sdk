...
class ChannelApi:
    ...
    def get_channel_agent(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param channel: Channel is the transport: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.
        :type channel: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_channel_agent_serialize(
            channel=channel,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_channel_agent_with_http_info(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_channel_agent_without_preload_content(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_channel_agent_serialize(
        self,
        channel,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/channel/agent',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_channel_allowlist(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport to read: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param channel: Channel is the transport to read: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.
        :type channel: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_channel_allowlist_serialize(
            channel=channel,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_channel_allowlist_with_http_info(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport to read: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_channel_allowlist_without_preload_content(
        self,
        channel: Annotated[Optional[StrictStr], Field(description="Channel is the transport to read: discord, github, linear, slack, teams, telegram or whatsapp. Required; an unknown value is a 404.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_channel_allowlist_serialize(
        self,
        channel,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/channel/allowlist',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_channel_inbox(
        ...
        _param = self._get_channel_inbox_serialize(
            since=since,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_channel_inbox_with_http_info(
        self,
        since: Annotated[Optional[StrictStr], Field(description="Since is the exclusive cursor: only messages with a higher row id come back. Empty starts at the beginning. Must parse as an integer.")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="Limit caps how many messages come back. Empty or 0 uses the store's default page size. Must parse as an integer.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_channel_inbox_without_preload_content(
        self,
        since: Annotated[Optional[StrictStr], Field(description="Since is the exclusive cursor: only messages with a higher row id come back. Empty starts at the beginning. Must parse as an integer.")] = None,
        limit: Annotated[Optional[StrictStr], Field(description="Limit caps how many messages come back. Empty or 0 uses the store's default page size. Must parse as an integer.")] = None,
        _request_timeout: Union[
    ...
    def _get_channel_inbox_serialize(
        self,
        since,
        limit,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/channel/inbox',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_channel_pairing(
        ...
        _param = self._get_channel_pairing_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_channel_pairing_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_channel_pairing_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_channel_pairing_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/channel/pairing',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_channel_by_channel_send(
        self,
        channel: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._post_channel_by_channel_send_serialize(
            channel=channel,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_channel_by_channel_send_with_http_info(
        self,
        channel: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_channel_by_channel_send_without_preload_content(
        self,
        channel: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _post_channel_by_channel_send_serialize(
        self,
        channel,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/channel/{channel}/send',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_channel_pairing_approve_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/channel/pairing/approve',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
