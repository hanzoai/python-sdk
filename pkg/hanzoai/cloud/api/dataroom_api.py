...
class DataroomApi:
    ...
    def get_dataroom_trust(
        ...
        _param = self._get_dataroom_trust_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_dataroom_trust_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_dataroom_trust_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_dataroom_trust_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/dataroom/trust',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the centre's public address. It resolves only for an org that has published; anything else is not found, so this cannot be used to learn which orgs exist.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_dataroom_trust_center_by_slug_serialize(
            slug=slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the centre's public address. It resolves only for an org that has published; anything else is not found, so this cannot be used to learn which orgs exist.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the centre's public address. It resolves only for an org that has published; anything else is not found, so this cannot be used to learn which orgs exist.")],
        _request_timeout: Union[
            None,
    ...
    def _get_dataroom_trust_center_by_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/dataroom/trust/center/{slug}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug_file_by_item(
        self,
        slug: StrictStr,
        item: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._get_dataroom_trust_center_by_slug_file_by_item_serialize(
            slug=slug,
            item=item,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug_file_by_item_with_http_info(
        self,
        slug: StrictStr,
        item: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_dataroom_trust_center_by_slug_file_by_item_without_preload_content(
        self,
        slug: StrictStr,
        item: StrictStr,
        _request_timeout: Union[
    ...
    def _get_dataroom_trust_center_by_slug_file_by_item_serialize(
        self,
        slug,
        item,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/dataroom/trust/center/{slug}/file/{item}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _patch_dataroom_trust_artifacts_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/dataroom/trust/artifacts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_dataroom_trust_artifacts_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/dataroom/trust/artifacts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_dataroom_trust_center_by_slug_requests_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/dataroom/trust/center/{slug}/requests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_dataroom_trust_requests_by_id_grant_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/dataroom/trust/requests/{id}/grant',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_dataroom_trust_requests_by_id_refuse_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/dataroom/trust/requests/{id}/refuse',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
