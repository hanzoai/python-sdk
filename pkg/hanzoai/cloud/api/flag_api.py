...
class FlagApi:
    ...
    def delete_flag_defs_by_key(
        ...
        _param = self._delete_flag_defs_by_key_serialize(
            key=key,
    ...
    @validate_call
    def delete_flag_defs_by_key_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_flag_defs_by_key_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_flag_defs_by_key_serialize(
        self,
        key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/flag/defs/{key}',
    ...
    def get_flag_activity(
        ...
        _param = self._get_flag_activity_serialize(
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_flag_activity_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps the rows returned. 1–500; anything else takes the default 100.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_flag_activity_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="Limit caps the rows returned. 1–500; anything else takes the default 100.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_flag_activity_serialize(
        self,
        limit,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/flag/activity',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_flag_defs(
        ...
        _param = self._get_flag_defs_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_flag_defs_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_flag_defs_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_flag_defs_by_key(
        ...
        _param = self._get_flag_defs_by_key_serialize(
            key=key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_flag_defs_by_key_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_flag_defs_by_key_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _get_flag_defs_by_key_serialize(
        self,
        key,
        _request_auth,
        _content_type,
    ...
    def get_flag_health(
        ...
        _param = self._get_flag_health_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_flag_health_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_flag_health_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_flag_health_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def put_flag_defs_by_key(
        ...
        _param = self._put_flag_defs_by_key_serialize(
            key=key,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def put_flag_defs_by_key_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to write, from the path.")],
        body: Optional[Any],
        _request_timeout: Union[
    ...
    @validate_call
    def put_flag_defs_by_key_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Key is the flag key to write, from the path.")],
        body: Optional[Any],
        _request_timeout: Union[
    ...
    def _put_flag_defs_by_key_serialize(
        self,
        key,
        body,
        _request_auth,
