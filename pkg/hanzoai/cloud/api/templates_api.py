...
class TemplatesApi:
    ...
    def delete_v1_templates_slug(
        ...
        _param = self._delete_v1_templates_slug_serialize(
            slug=slug,
    ...
    @validate_call
    def delete_v1_templates_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_v1_templates_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_v1_templates_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
    ...
    def get_v1_templates_slug(
        ...
        _param = self._get_v1_templates_slug_serialize(
            slug=slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_v1_templates_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_templates_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the starter kit to act on, from the path.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_templates_slug_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
    ...
    def put_v1_templates_slug(
        ...
        _param = self._put_v1_templates_slug_serialize(
            slug=slug,
    ...
    @validate_call
    def put_v1_templates_slug_with_http_info(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the kit to replace, from the path.")],
        replace_kit_in: ReplaceKitIn,
        _request_timeout: Union[
    ...
    @validate_call
    def put_v1_templates_slug_without_preload_content(
        self,
        slug: Annotated[StrictStr, Field(description="Slug is the kit to replace, from the path.")],
        replace_kit_in: ReplaceKitIn,
        _request_timeout: Union[
    ...
    def _put_v1_templates_slug_serialize(
        self,
        slug,
        replace_kit_in,
        _request_auth,
