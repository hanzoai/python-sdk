...
class AuthorsApi:
    ...
    def cloud_get_v1_authors(
        ...
        _param = self._cloud_get_v1_authors_serialize(
    ...
    @validate_call
    def cloud_get_v1_authors_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def cloud_get_v1_authors_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _cloud_get_v1_authors_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def cloud_get_v1_authors_basis(
        self,
        ...
        _param = self._cloud_get_v1_authors_basis_serialize(
            period=period,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cloud_get_v1_authors_basis_with_http_info(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Period is the UTC accrual month, YYYY-MM. Empty means every period; any other shape is refused with 400, because the period is echoed back and used as a SQL filter and is only ever accepted in the one form the accrual latch mints.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_get_v1_authors_basis_without_preload_content(
        self,
        period: Annotated[Optional[StrictStr], Field(description="Period is the UTC accrual month, YYYY-MM. Empty means every period; any other shape is refused with 400, because the period is echoed back and used as a SQL filter and is only ever accepted in the one form the accrual latch mints.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cloud_get_v1_authors_basis_serialize(
        self,
        period,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cloud_post_v1_authors_connect(
        self,
        cloud_connect_request: CloudConnectRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_connect_request: (required)
        :type cloud_connect_request: CloudConnectRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_authors_connect_serialize(
            cloud_connect_request=cloud_connect_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_authors_connect_with_http_info(
        self,
        cloud_connect_request: CloudConnectRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_authors_connect_without_preload_content(
        self,
        cloud_connect_request: CloudConnectRequest,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_authors_connect_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_connect_request is not None:
            _body_params = cloud_connect_request
    ...
    @validate_call
    def cloud_post_v1_authors_deploys_record(
        self,
        cloud_deploy_request: CloudDeployRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_deploy_request: (required)
        :type cloud_deploy_request: CloudDeployRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_authors_deploys_record_serialize(
            cloud_deploy_request=cloud_deploy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_authors_deploys_record_with_http_info(
        self,
        cloud_deploy_request: CloudDeployRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_authors_deploys_record_without_preload_content(
        self,
        cloud_deploy_request: CloudDeployRequest,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_authors_deploys_record_serialize(
        self,
        cloud_deploy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_deploy_request is not None:
            _body_params = cloud_deploy_request
    ...
    @validate_call
    def cloud_post_v1_authors_repos_verify(
        self,
        cloud_verify_request: CloudVerifyRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param cloud_verify_request: (required)
        :type cloud_verify_request: CloudVerifyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._cloud_post_v1_authors_repos_verify_serialize(
            cloud_verify_request=cloud_verify_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def cloud_post_v1_authors_repos_verify_with_http_info(
        self,
        cloud_verify_request: CloudVerifyRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cloud_post_v1_authors_repos_verify_without_preload_content(
        self,
        cloud_verify_request: CloudVerifyRequest,
        _request_timeout: Union[
            None,
    ...
    def _cloud_post_v1_authors_repos_verify_serialize(
        self,
        cloud_verify_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if cloud_verify_request is not None:
            _body_params = cloud_verify_request
