...
class SettingsApi:
    ...
    def get_v1_settings_product(
        ...
        _param = self._get_v1_settings_product_serialize(
            product=product,
    ...
    @validate_call
    def get_v1_settings_product_with_http_info(
        self,
        product: Annotated[StrictStr, Field(description="Product is the catalog slug, from the path. Must match ^[a-z0-9][a-z0-9._-]{0,62}$.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_v1_settings_product_without_preload_content(
        self,
        product: Annotated[StrictStr, Field(description="Product is the catalog slug, from the path. Must match ^[a-z0-9][a-z0-9._-]{0,62}$.")],
        _request_timeout: Union[
            None,
    ...
    def _get_v1_settings_product_serialize(
        self,
        product,
        _request_auth,
        _content_type,
    ...
    def put_v1_settings_product(
        ...
        _param = self._put_v1_settings_product_serialize(
            product=product,
    ...
    @validate_call
    def put_v1_settings_product_with_http_info(
        self,
        product: Annotated[StrictStr, Field(description="Product is the catalog slug, from the PATH. zip binds the path last, so the URL names the product being written whatever a body field claims.")],
        settings_req: SettingsReq,
        _request_timeout: Union[
    ...
    @validate_call
    def put_v1_settings_product_without_preload_content(
        self,
        product: Annotated[StrictStr, Field(description="Product is the catalog slug, from the PATH. zip binds the path last, so the URL names the product being written whatever a body field claims.")],
        settings_req: SettingsReq,
        _request_timeout: Union[
    ...
    def _put_v1_settings_product_serialize(
        self,
        product,
        settings_req,
        _request_auth,
