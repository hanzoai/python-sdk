...
class SecretList(BaseModel):
    ...
    SecretList
    """ # noqa: E501
    secrets: Optional[List[SecretView]] = Field(default=None, description="Secrets is one row per distinct (namespace, name) a function mounts. Values are NEVER read or returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secrets": [SecretView.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
