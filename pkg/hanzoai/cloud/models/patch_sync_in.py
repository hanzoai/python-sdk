...
class PatchSyncIn(BaseModel):
    ...
    kind: Optional[StrictStr] = Field(default=None, description="Kind names a different kind of sync, and is refused, for the same reason.")
    ...
    target: Optional[EndpointReq] = Field(default=None, description="Target names a new native repository, and is refused, for the same reason.")
