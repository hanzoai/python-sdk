...
class NexusMessage(BaseModel):
    ...
    suggestions: Optional[List[NexusSuggestion]] = None
    ...
    vector_scores: Optional[List[NexusVectorScore]] = Field(default=None, alias="vectorScores")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NexusMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NexusMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "store": obj.get("store"),
            "suggestions": [NexusSuggestion.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None,
            "text": obj.get("text"),
            "textTokenCount": obj.get("textTokenCount"),
            "tokenCount": obj.get("tokenCount"),
            "user": obj.get("user"),
            "vectorScores": [NexusVectorScore.from_dict(_item) for _item in obj["vectorScores"]] if obj.get("vectorScores") is not None else None
        })
        return _obj
