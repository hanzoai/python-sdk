...
class O11yO11yQueueFilterRule(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yO11yQueueFilterRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yO11yQueueFilterRule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "key": O11yO11yQueueFilterKey.from_dict(obj["key"]) if obj.get("key") is not None else None,
            "op": obj.get("op"),
            "value": obj.get("value")
        })
        return _obj
