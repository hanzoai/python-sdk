...
class Layout(BaseModel):
    ...
    form_items: Optional[List[FormItem]] = Field(default=None, alias="formItems")
    ...
    __properties: ClassVar[List[str]] = ["category", "createdTime", "displayName", "formItems", "name", "owner", "position", "tag", "type", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formItems": [FormItem.from_dict(_item) for _item in obj["formItems"]] if obj.get("formItems") is not None else None,
            "name": obj.get("name"),
            "owner": obj.get("owner"),
