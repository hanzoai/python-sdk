...
class UsageAnalyticsView(BaseModel):
    """
    UsageAnalyticsView
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageAnalyticsView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageAnalyticsView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plan": obj.get("plan"),
            "providers": ProviderBreakdown.from_dict(obj["providers"]) if obj.get("providers") is not None else None,
            "range": obj.get("range"),
