...
class OpenaiCompletionTokensDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["audio_tokens", "reasoning_tokens"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenaiCompletionTokensDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenaiCompletionTokensDetails from a dict"""
        if obj is None:
            return None
