...
class OptinView(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OptinView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OptinView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "org": OrgOptinView.from_dict(obj["org"]) if obj.get("org") is not None else None,
            "user": UserOptinView.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
