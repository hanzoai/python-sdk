...
class O11yO11yFeature(BaseModel):
    """
    O11yO11yFeature
    """ # noqa: E501
    default_variant: Optional[StrictStr] = Field(default=None, description="DefaultVariant is the variant used when nothing overrides it.", alias="defaultVariant")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yO11yFeature from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yO11yFeature from a dict"""
        if obj is None:
            return None
