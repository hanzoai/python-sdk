...
class AiProviderUsageTotals(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["inputTokens", "outputTokens", "requests", "spendCents", "tokens"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AiProviderUsageTotals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AiProviderUsageTotals from a dict"""
        if obj is None:
            return None
