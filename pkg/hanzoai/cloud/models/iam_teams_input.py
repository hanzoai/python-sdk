...
class IamTeamsInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdTime", "description", "displayName", "isEnabled", "name", "organization", "parent", "users"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IamTeamsInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IamTeamsInput from a dict"""
        if obj is None:
            return None
