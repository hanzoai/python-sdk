...
class NexusNode(BaseModel):
    ...
    patches: Optional[List[NexusPatch]] = None
    ...
    remote_apps: Optional[List[NexusRemoteApp]] = Field(default=None, alias="remoteApps")
    ...
    services: Optional[List[NexusService]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NexusNode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NexusNode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "os": obj.get("os"),
            "owner": obj.get("owner"),
            "patches": [NexusPatch.from_dict(_item) for _item in obj["patches"]] if obj.get("patches") is not None else None,
            "privateIp": obj.get("privateIp"),
            "publicIp": obj.get("publicIp"),
            "remoteApps": [NexusRemoteApp.from_dict(_item) for _item in obj["remoteApps"]] if obj.get("remoteApps") is not None else None,
            ...
            "services": [NexusService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None,
            "size": obj.get("size"),
            "tag": obj.get("tag"),
            "type": obj.get("type"),
