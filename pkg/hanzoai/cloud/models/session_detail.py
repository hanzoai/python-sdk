...
class SessionDetail(BaseModel):
    ...
    child_sessions: Optional[List[SessionView]] = Field(default=None, alias="childSessions")
    ...
    recent_events: Optional[List[EventView]] = Field(default=None, alias="recentEvents")
