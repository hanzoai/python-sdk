...
class PeriodEarningView(BaseModel):
    """
    PeriodEarningView
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeriodEarningView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeriodEarningView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "marginCents": obj.get("marginCents"),
