...
class Range(BaseModel):
    ...
    Range
    """ # noqa: E501
    end: Optional[Position] = Field(default=None, description="End is the position just past the span, excluded — the range is half-open, so an empty range has Start equal to End.")
    start: Optional[Position] = Field(default=None, description="Start is the first position in the span, included.")
