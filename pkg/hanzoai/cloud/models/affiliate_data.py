...
class AffiliateData(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AffiliateData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AffiliateData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "affiliate": AdminAffiliateView.from_dict(obj["affiliate"]) if obj.get("affiliate") is not None else None
        })
        return _obj
