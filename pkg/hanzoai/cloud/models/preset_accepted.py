...
class PresetAccepted(BaseModel):
    """
    PresetAccepted
    """ # noqa: E501
    note: Optional[StrictStr] = Field(default=None, description="Note explains what acceptance does and does not promise.")
    preset: Optional[Preset] = Field(default=None, description="Preset is the blend with its defaults filled in.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PresetAccepted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PresetAccepted from a dict"""
        if obj is None:
            return None
