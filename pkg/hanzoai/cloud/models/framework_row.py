...
class FrameworkRow(BaseModel):
    ...
    framework: Optional[StrictStr] = Field(default=None, description="Framework is the framework id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FrameworkRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FrameworkRow from a dict"""
        if obj is None:
            return None
