...
class ModelAccess(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdTime", "email", "model", "owner", "status", "updatedTime", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelAccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelAccess from a dict"""
        if obj is None:
            return None
