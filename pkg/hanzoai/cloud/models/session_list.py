...
class SessionList(BaseModel):
    ...
    SessionList
    """ # noqa: E501
    sessions: Optional[List[SessionView]] = Field(default=None, description="Sessions is the matching sessions, each with its event and child counts and a one-line preview of its latest event.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sessions": [SessionView.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
