...
class RunnerBuildResp(BaseModel):
    ...
    RunnerBuildResp
    """ # noqa: E501
    build_job_id: Optional[StrictStr] = Field(default=None, description="BuildJobID is the queued build's id, and what a release is followed by.", alias="buildJobId")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status is `queued` for an ordinary build, `releasing` for a self-publish.")
