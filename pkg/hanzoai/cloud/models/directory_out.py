...
class DirectoryOut(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectoryOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectoryOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": DirectoryData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "msg": obj.get("msg"),
