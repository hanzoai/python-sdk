...
class IamListOrganizationsOutput(BaseModel):
    """
    IamListOrganizationsOutput
    """ # noqa: E501
    count: Optional[StrictInt] = None
    organizations: Optional[List[IamOrganization]] = None
    __properties: ClassVar[List[str]] = ["count", "organizations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IamListOrganizationsOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IamListOrganizationsOutput from a dict"""
        if obj is None:
            return None
