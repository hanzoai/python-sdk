...
class IngressRoutes(BaseModel):
    """
    IngressRoutes
    """ # noqa: E501
    routes: Optional[List[Route]] = Field(default=None, description="Routes is the org's routes, ordered by id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IngressRoutes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IngressRoutes from a dict"""
        if obj is None:
            return None
