...
class GitOpsPlane(BaseModel):
    """
    GitOpsPlane
    """ # noqa: E501
    applications: Optional[List[GitOpsApp]] = Field(default=None, description="Applications is every CD Application in the cluster, ordered by namespace then name. Empty (never null) when the plane is not installed, and equally empty when it is installed and tracks nothing — Installed is what separates those two.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitOpsPlane from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitOpsPlane from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "applications": [GitOpsApp.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
