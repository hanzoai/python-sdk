...
class RefreshOut(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefreshOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefreshOut from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connector": ConnView.from_dict(obj["connector"]) if obj.get("connector") is not None else None,
