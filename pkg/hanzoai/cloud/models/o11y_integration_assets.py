...
class O11yIntegrationAssets(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yIntegrationAssets from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yIntegrationAssets from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "logs": O11yLogsAssets.from_dict(obj["logs"]) if obj.get("logs") is not None else None
        })
        return _obj
