...
class Task(BaseModel):
    ...
    document_text: Optional[StrictStr] = Field(default=None, alias="documentText")
    ...
    __properties: ClassVar[List[str]] = ["activity", "createdTime", "displayName", "documentText", "documentUrl", "example", "grade", "labels", "log", "name", "owner", "path", "provider", "result", "scale", "score", "subject", "topic", "type"]
