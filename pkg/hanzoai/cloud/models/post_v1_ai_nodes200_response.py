...
class PostV1AiNodes200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV1AiNodes200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV1AiNodes200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": Node.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "data2": obj.get("data2"),
            "msg": obj.get("msg"),
