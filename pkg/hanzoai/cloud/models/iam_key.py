...
class IamKey(BaseModel):
    ...
    IamKey
    """ # noqa: E501
    access_key: Optional[StrictStr] = Field(default=None, description="AccessKey (pk-*) is the publishable identifier and lookup index; AccessSecret (sk-*) is the confidential secret.", alias="accessKey")
    ...
    __properties: ClassVar[List[str]] = ["accessKey", "accessSecret", "application", "createdAt", "createdTime", "deleted", "displayName", "expireTime", "id", "name", "organization", "owner", "scope", "state", "type", "updatedAt", "updatedTime", "user"]
