...
class LicensingReleaseAsset(BaseModel):
    """
    ...
    release: Optional[LicensingRelease] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LicensingReleaseAsset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LicensingReleaseAsset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "release": LicensingRelease.from_dict(obj["release"]) if obj.get("release") is not None else None
        })
        return _obj
