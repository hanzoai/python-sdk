...
class SampleList(BaseModel):
    ...
    SampleList
    """ # noqa: E501
    samples: Optional[List[SampleView]] = Field(default=None, description="Samples are the readings, OLDEST first — the order a chart plots.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "samples": [SampleView.from_dict(_item) for _item in obj["samples"]] if obj.get("samples") is not None else None
        })
        return _obj
