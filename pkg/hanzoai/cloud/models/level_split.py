...
class LevelSplit(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LevelSplit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LevelSplit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "l1Cents": obj.get("l1Cents"),
            "l2Cents": obj.get("l2Cents"),
            "l3Cents": obj.get("l3Cents")
        })
        return _obj
