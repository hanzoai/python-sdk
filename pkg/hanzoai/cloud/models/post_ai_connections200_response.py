...
class PostAiConnections200Response(BaseModel):
    """
    PostAiConnections200Response
    """ # noqa: E501
    data: Optional[AiAiConnResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostAiConnections200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostAiConnections200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": AiAiConnResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "data2": obj.get("data2"),
            "msg": obj.get("msg"),
