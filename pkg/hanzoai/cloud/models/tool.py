...
class Tool(BaseModel):
    ...
    price: Optional[Price] = Field(default=None, description="Price is what a call costs and who is paid, absent for a free tool. Enforcement is the x402 settlement seam; this is the declaration.")
