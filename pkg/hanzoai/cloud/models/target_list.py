...
class TargetList(BaseModel):
    ...
    TargetList
    """ # noqa: E501
    targets: Optional[List[TargetView]] = Field(default=None, description="Targets is every target registered to the caller's org.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targets": [TargetView.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
