...
class PubkeyView(BaseModel):
    ...
    keys: Optional[List[JWK]] = Field(default=None, description="Keys is the same key as a single-entry JWKS (OKP/Ed25519), for JWKS-shaped consumers.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PubkeyView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PubkeyView from a dict"""
        if obj is None:
            return None
