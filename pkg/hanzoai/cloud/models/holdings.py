...
class Holdings(BaseModel):
    ...
    Holdings
    """ # noqa: E501
    domains: Optional[List[Holding]] = Field(default=None, description="Domains is the caller org's domains, newest registration first.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domains": [Holding.from_dict(_item) for _item in obj["domains"]] if obj.get("domains") is not None else None
        })
        return _obj
