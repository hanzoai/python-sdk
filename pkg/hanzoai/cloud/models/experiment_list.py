...
class ExperimentList(BaseModel):
    ...
    ExperimentList
    """ # noqa: E501
    data: Optional[List[Trial]] = Field(default=None, description="Data is the org's experiments, ordered by project then id.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Trial.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
