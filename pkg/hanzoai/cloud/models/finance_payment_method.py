...
class FinancePaymentMethod(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["brand", "expMonth", "expYear", "id", "isDefault", "last4", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinancePaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinancePaymentMethod from a dict"""
        if obj is None:
            return None
