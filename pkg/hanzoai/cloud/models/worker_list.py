...
class WorkerList(BaseModel):
    ...
    WorkerList
    """ # noqa: E501
    workers: Optional[List[ByoWorker]] = Field(default=None, description="Workers is one row per connected BYO machine, each carrying the host's own report (GPUs, driver versions, capabilities) rather than a normalized view.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workers": [ByoWorker.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None
        })
        return _obj
