...
class O11yPodCountsByPhase(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["failed", "pending", "running", "succeeded", "unknown"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yPodCountsByPhase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yPodCountsByPhase from a dict"""
        if obj is None:
            return None
