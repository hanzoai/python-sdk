...
class O11yEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributeMap", "isError", "name", "timeUnixNano"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yEvent from a dict"""
        if obj is None:
            return None
