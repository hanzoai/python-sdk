...
class O11yO11yDashboardVarValues(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yO11yDashboardVarValues from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yO11yDashboardVarValues from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "variableValues": obj.get("variableValues")
        })
        return _obj
