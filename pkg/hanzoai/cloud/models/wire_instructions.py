...
class WireInstructions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountName", "accountNumber", "bankAddress", "bankName", "iban", "memo", "reference", "routingNumber", "swiftCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WireInstructions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WireInstructions from a dict"""
        if obj is None:
            return None
