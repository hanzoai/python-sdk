...
class GetModelsProviders200Response(BaseModel):
    """
    GetModelsProviders200Response
    """ # noqa: E501
    data: Optional[AiModelProviders] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetModelsProviders200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetModelsProviders200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": AiModelProviders.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "data2": obj.get("data2"),
            "msg": obj.get("msg"),
