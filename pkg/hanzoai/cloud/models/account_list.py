...
class AccountList(BaseModel):
    ...
    AccountList
    """ # noqa: E501
    accounts: Optional[List[WalletAccount]] = Field(default=None, description="Accounts are the org's accounts, newest first.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [WalletAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
