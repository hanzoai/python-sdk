...
class Capabilities(BaseModel):
    ...
    group: Optional[StrictBool] = Field(default=None, description="Group is whether the transport carries multi-person rooms — a Discord guild channel, a Slack channel, a Teams channel or group chat, a Telegram group or supergroup. True on all four.")
    media: Optional[StrictBool] = Field(default=None, description="Media is whether the transport renders an ATTACHMENT natively. False on all four this pass, and a send is not refused for it: renderText flattens each attachment to one `kind: url (mime)` line after the text rather than dropping it.")
