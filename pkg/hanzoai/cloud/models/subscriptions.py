...
class Subscriptions(BaseModel):
    ...
    Subscriptions
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Count is the row count beside the rows, which is the shape this address has always answered with.")
    subscriptions: Optional[List[Subscription]] = None
    __properties: ClassVar[List[str]] = ["count", "subscriptions"]
