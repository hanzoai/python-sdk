...
class O11yOtelSpanRef(BaseModel):
    """
    O11yOtelSpanRef
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["refType", "spanId", "traceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yOtelSpanRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yOtelSpanRef from a dict"""
        if obj is None:
            return None
