...
class LinkMint(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkMint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkMint from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "link": CodeView.from_dict(obj["link"]) if obj.get("link") is not None else None
        })
        return _obj
