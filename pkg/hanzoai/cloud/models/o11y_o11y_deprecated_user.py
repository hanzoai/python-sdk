...
class O11yO11yDeprecatedUser(BaseModel):
    """
    ...
    role: Optional[StrictStr] = Field(default=None, description="Role is their legacy role — ADMIN, EDITOR or VIEWER.")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "displayName", "email", "id", "isRoot", "orgId", "role", "status", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of O11yO11yDeprecatedUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of O11yO11yDeprecatedUser from a dict"""
        if obj is None:
            return None
