...
class SandboxList(BaseModel):
    ...
    SandboxList
    """ # noqa: E501
    sandboxes: Optional[List[Sandbox]] = Field(default=None, description="Sandboxes are the caller org's sandboxes matching the filter. Never null.")
    __properties: ClassVar[List[str]] = ["sandboxes"]
