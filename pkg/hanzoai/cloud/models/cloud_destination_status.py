...
class CloudDestinationStatus(BaseModel):
    """
    ...
    fields: Optional[List[CloudDestinationField]] = Field(default=None, description="Fields are the non-secret inputs this platform needs, which the console card renders and the connect body fills.")
    ...
    __properties: ClassVar[List[str]] = ["account", "category", "config", "connected", "enabled", "fields", "live", "name", "platform", "secrets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudDestinationStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudDestinationStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fields": [CloudDestinationField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "live": obj.get("live"),
            "name": obj.get("name"),
