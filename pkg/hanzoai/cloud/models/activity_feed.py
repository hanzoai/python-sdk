...
class ActivityFeed(BaseModel):
    ...
    ActivityFeed
    """ # noqa: E501
    activity: Optional[List[ActivityView]] = Field(default=None, description="Activity is the merged run/create/update events, newest first, capped at 50.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activity": [ActivityView.from_dict(_item) for _item in obj["activity"]] if obj.get("activity") is not None else None
        })
        return _obj
