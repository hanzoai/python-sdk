...
class NetworkList(BaseModel):
    ...
    NetworkList
    """ # noqa: E501
    networks: Optional[List[NetworkView]] = Field(default=None, description="Networks holds the org's overlay network, or is empty when the org has no edge-routers on the fabric (no nodes → no network, never a fabricated one).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networks": [NetworkView.from_dict(_item) for _item in obj["networks"]] if obj.get("networks") is not None else None
        })
        return _obj
