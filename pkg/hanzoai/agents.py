...
try:
    ...
    from hanzo_agents import (
        ...
        # Core agent types
        BaseAgent, LocalAgent, RemoteAgent,
        # CLI agents
        ClaudeCodeAgent, OpenAICodexAgent, 
        GeminiAgent, GrokAgent,
        # Network features
        PeerNetwork, SwarmNetwork,
        # Utilities
        AgentConfig, NetworkConfig,
    )
    ...
    def _agents_not_installed(*args, **kwargs):
        raise ImportError(
            "hanzo-agents is not installed. "
            "Install it with: pip install hanzo-agents"
        )
