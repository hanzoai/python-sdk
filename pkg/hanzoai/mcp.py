...
try:
    ...
    from hanzo_mcp import (
        # Server creation
        HanzoMCPServer, create_server,
        # Tool registration
        register_all_tools, register_all_prompts,
        # Tool categories
        get_filesystem_tools, get_shell_tools, get_agent_tools,
        get_search_tools, get_jupyter_tools, get_git_tools,
        get_memory_tools,
        # Base classes
    ...
    def _mcp_not_installed(*args, **kwargs):
        raise ImportError(
            "hanzo-mcp is not installed. "
            "Install it with: pip install hanzo-mcp"
        )
...
__all__ = [
    # Server
    'HanzoMCPServer', 'create_server', 'create_mcp_server', 'run_mcp_server',
    # Tools
    'register_all_tools', 'register_all_prompts',
    'get_filesystem_tools', 'get_shell_tools', 'get_agent_tools',
    'get_search_tools', 'get_jupyter_tools', 'get_git_tools',
