    ...
    try:
        ...
        result = await Runner.run(
            ...
            run_config=RunConfig(
                model_provider=provider, model="claude-3-sonnet-20240229"
            ),
        )
        ...
        print("\nTroubleshooting:")
        print(
            "1. Make sure Hanzo Router is running: cd /Users/z/work/hanzo/services && docker compose -f docker-compose.mothership.yml up router"
        )
