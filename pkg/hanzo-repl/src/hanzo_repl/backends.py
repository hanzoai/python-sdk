...
class ClaudeCodeBackend(Backend):
    ...
    def _find_claude_code(self) -> Optional[str]:
        ...
        for path in paths:
            try:
                ...
                )  # Safe: running known executable with fixed arguments
    ...
    def _check_auth(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(  # noqa: S603
                [self.cli_path, "auth", "status"], capture_output=True, text=True
            )  # Safe: running validated Claude executable with fixed arguments
